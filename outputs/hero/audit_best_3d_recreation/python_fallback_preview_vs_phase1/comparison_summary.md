...
1. Side profile improved: **False**. Continuity score is None; occupied voxels changed from 3834 to 0; depth span 0.000 vs baseline 0.600.
...
4. Face/voxel budget ok: **True**. Candidate faces 0; baseline faces 3500; profile budget treated as 4000.
